...
<c:choose>
    ...
    <div class ="list-container" style="margin-top:50px;">
        ...
        <div class="flex-box">
            ...
            <div class ="flex-box-item" onclick='location.href="movie?command=lastmovie"'>
                상영종료작
            </div>
        </div>
        ...
        <div class = "flex-box">
            <div class ="align-left">
                <span style="font-size:20px; color:#037B94; font-weight: 600;">${totalCnt}</span>개의 영화가 검색되었습니다.
            </div>
            <div class="align-right">
                <form action="movie" method="get" id="search_movie">
                	<input type = "hidden" name="command" value="commingsoon">
        ...
        <c:choose>
        	<c:when test="${totalCnt eq 0}">
        		<div style="text-align: center; margin:0px 0px 30px 0px; font-size: 20px;">상영예정인 영화가 없습니다.</div>
        	</c:when>
        </c:choose>
            ...
            <div class = "movie-box"><a href="movie?command=view&movie_id=${list.id}">
                ...
                <div class="movie-box-contents">
                    ...
                    <span style="border-right: 1px solid lightgray; padding-right: 7px;"> 예매율 - </span>
                    <span style="padding-left: 1px;">개봉일 <fmt:formatDate value="${list.date}" pattern="yyyy.MM.dd"/></span>
						<div style="display: flex;">
						 ...
						 <div class="reserve-btn2" style="font-size: 15px;text-align: center;line-height: 35px">상영예정</div>
	                 	</div>
               	</div>
