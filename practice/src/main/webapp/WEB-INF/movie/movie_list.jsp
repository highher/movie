                ...
                <div class="movie-box-contents">
                 <div style="font-size: 17px; margin: 5px; font-weight: 600;">
                    <c:choose>
	                    ...
	                    <span style="font-size: 14px; border-right: 1px solid lightgray; padding-right: 7px;"> 예매율 <fmt:formatNumber value="${list.sales/list.total*100}" pattern="#.#"/>%</span>
	                    <span style="font-size: 14px; padding-left: 1px;">개봉일 <fmt:formatDate value="${list.date}" pattern="yyyy.MM.dd"/></span>
						 ...
						 <div class="reserve-btn" style="font-size: 18px;text-align: center;line-height: 35px" onclick='location.href="movie?command=totalreserve"'>예매</div>
	                 	</div>
	               	</div>
               	</div>
			</c:forEach>
